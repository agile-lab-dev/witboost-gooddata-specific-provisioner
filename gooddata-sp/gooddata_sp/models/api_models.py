...
class ProvisioningRequest(BaseModel):
    ...
    removeData: Optional[bool] = Field(default=None, description="If true, when a component is undeployed, its underlying data will also be deleted") # noqa: E501
...
class ErrorMoreInfo(BaseModel):
    problems: List[str] = Field(..., description="Array of possible multiple problems: i.e. multiple validations failed") # noqa: E501
    solutions: List[str] = Field(..., description="Array of possible solutions that the developer gives to the user to solve the issue") # noqa: E501
...
class RequestValidationError(BaseModel):
    ...
    input: Optional[str] = Field(default=None, description="Optional field to include the file or descriptor that raised the error") # noqa: E501
    inputErrorField: Optional[str] = Field(default=None, description="Optional field to include the field path (in dot format) that raised the error") # noqa: E501
...
class ProvisionInfo(BaseModel):
    ...
    result: str = Field(
        ...,
        description="Result message (e.g. a provisioning error or a success message returned by the specific provisioner in the [ProvisioningStatus](#/components/schemas/ProvisioningStatus))",  # noqa: E501
    )
...
class ReverseProvisioningRequest(BaseModel):
    ...
    catalogInfo: Optional[Dict] = Field(default=None,
