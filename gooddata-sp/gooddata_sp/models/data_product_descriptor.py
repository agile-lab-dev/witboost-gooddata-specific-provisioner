...
from gooddata_sp.models.constants import OPENMETADATA_SUPPORTED_DATATYPES
...
class ComponentKind(CaseInsensitiveStrEnum):
...
class TagSourceTagLabel(CaseInsensitiveStrEnum):
    CLASSIFICATION = "CLASSIFICATION"
    GLOSSARY = "GLOSSARY"


class LabelTypeTagLabel(CaseInsensitiveStrEnum):
    MANUAL = "MANUAL"
...
class StateTagLabel(CaseInsensitiveStrEnum):
    SUGGESTED = "SUGGESTED"
    CONFIRMED = "CONFIRMED"
...
class ConnectionTypeWorkload(CaseInsensitiveStrEnum):
